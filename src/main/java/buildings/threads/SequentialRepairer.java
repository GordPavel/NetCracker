...
public class SequentialRepairer implements Runnable{
    ...
    public SequentialRepairer( CountDownLatch starter , CountDownLatch finisher , Semaphore repairingSemaphore ,
    ...
    public void run(){
        ...
        try{
            while( goingSpaceIndex.intValue() < floor.getSpacesCount() ){
                ...
                System.out.printf( "%3$s repairing space number %2$d with total area %1$.2f square meters\n" ,
